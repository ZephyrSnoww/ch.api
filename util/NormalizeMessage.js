...
exports.NormalizeMessage = async (message, client) => {
    ...
    if (client.name === "Telegram") {
        ...
        normalizedMessage.unpin = () => client.client.unpinChatMessage(message.chat.id, message.message_id);
    }
    ...
    if (client.name === "Discord") {
        ...
        normalizedMessage.unpin = () => message.unpin();
    }
    ...
    if (client.name === "Revolt") {
        ...
        normalizedMessage.unpin = () => { return null };
    }
